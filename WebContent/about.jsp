...
<html>
    ...
    <body>
        ...
        <h1 class="page-header text-center">About Phonekart</h1>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <ul class="list-group">
                        In today's world online shopping is one of the most popular things especially
                        amongst youngsters. Phonekart provides a safe online shopping experience to 
                        the consumers. We deal with various manufacturer's mobile phones.
                    </ul>
                </div>                
            </div>
        </div>
